...
- Guide
   ...
   5. Start **courage/client** with Live Server or _copy_ **all files in courage/client** and _paste_ to **courage/src/main/resources/static** or **courage/src/main/webapp**
